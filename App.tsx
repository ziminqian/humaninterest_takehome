  ...
  return (
    <SafeAreaView style={styles.safeArea}>
      ...
      <ScrollView contentContainerStyle={styles.container}>
        ...
        <View style={[styles.heroSection, styles.sectionSpacing]}>
          <View style={styles.heroIconBadge}>
            <Calculator color={COLORS.white} size={32} />
          </View>
          ...
          <Text style={styles.heroCopy}>
            Pick your contribution style, tune the amount that fits every paycheck, and see how your choices steer long-term savings.
          </Text>
        </View>
